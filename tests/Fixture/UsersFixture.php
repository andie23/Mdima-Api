...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'email' => ['type' => 'string', 'length' => 65, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'phone' => ['type' => 'unique', 'columns' => ['phone', 'email', 'username'], 'length' => []],
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['gender_id'], 'references' => ['genders', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public $records = [
        [
            ...
            'role_id' => 1,
            'created' => '2018-09-16 21:39:42',
            'modified' => '2018-09-16 21:39:42'
        ],
    ];
}
