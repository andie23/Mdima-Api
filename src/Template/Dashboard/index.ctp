            ...
            <div class="row justify-content-center features">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-map-marker icon"></i>
                        ...
                        <a href="#" class="badge badge-primary">Locations</a>
                        <a href="#" class="badge badge-primary">Areas</a>
                        <a href="#" class="badge badge-primary">Regions</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-clock-o icon"></i>
                        ...
                        <a href="#" class="badge badge-primary">Programmes</a>
                        <a href="#" class="badge badge-primary">Groups</a>
                        <a href="#" class="badge badge-primary">Schedules</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><i class="fa fa-list-alt icon"></i>
                        ...
                        <a href="#" class="badge badge-primary">Notify</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
